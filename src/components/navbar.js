...
export default function Navbar() {
  ...
  return (
    ...
    <Disclosure as="nav" className="bg-gray-800">
            ...
            {token ? (
              ...
              <Menu as="div" className="relative ml-3">
                ...
                <MenuItems className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none">
                  <MenuItem>
                    <Link href="/journals" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Your Journals
                    </Link>
                  </MenuItem>
                  <MenuItem>
                    <Link href="/" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={() => {
      ...
      {/* Mobile DisclosurePanel (optional: show Sign In/Register here too if needed) */}
      {/* You can duplicate the same token check here if you want mobile menu links */}
    </Disclosure>
  )
}